                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 py-12 mx-auto">
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                @endif
                                <form action="{{ route('admin.user_attendance_record.store', ['id' => $id]) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="p-2 my-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="break_time" name="break_time" value="{{ old('break_time', '01:00') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                    </div>
