                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 py-12 mx-auto">
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                @endif
                                <form action="{{ route('user.leave_application.store') }}" method="POST">
                                    @csrf
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 my-2 w-full flex justify-around">
                                            ...
                                            <button type="submit" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">申請</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
